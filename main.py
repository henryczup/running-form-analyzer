...
def parse_arguments():
    ...
    parser.add_argument('--side', type=str, default='right', choices=['left', 'right'], help="Side of the body to analyze")
    parser.add_argument('--runner_height', type=float, default=182, help="Height of the runner in cm")
